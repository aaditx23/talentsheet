...
export default function PortfolioPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 space-y-16 mt-16">
      {/* Header / About */}
      <section className="space-y-4">
        <h1 className="text-5xl font-bold tracking-tight">{user.displayName}</h1>
        <p className="text-2xl text-muted-foreground font-medium">{user.tagline}</p>
        <p className="text-lg leading-relaxed max-w-3xl">{user.about}</p>
      </section>
